...
class ConnectionUtils:
    ...
    @staticmethod
    async def send_message(websocket: WebSocketServerProtocol, message: Dict[str, Any]) -> bool:
    ...
    @staticmethod
    async def send_error(websocket: WebSocketServerProtocol, error_message: str) -> bool:
    ...
    @staticmethod
    async def broadcast_to_connections(connections: Set[WebSocketServerProtocol], 
                                     message: Dict[str, Any]) -> List[WebSocketServerProtocol]:
        """
...
class GameServer:
    ...
    async def handle_server_command(self, websocket: WebSocketServerProtocol, data: Dict[str, Any]) -> None:
